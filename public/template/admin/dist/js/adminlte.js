...
(function (global, factory) {
  ...
  var SELECTOR_DROPDOWN_MENU_ACTIVE = '.dropdown-menu.show.blade.php';
  ...
  var Dropdown = /*#__PURE__*/function () {
    ...
    _proto.toggleSubmenu = function toggleSubmenu() {
      ...
      if (!this._element.next().hasClass('show')) {
        this._element.parents(SELECTOR_DROPDOWN_MENU).first().find('.show.blade.php').removeClass('show').hide();
      }

      this._element.parents('li.nav-item.dropdown.show.blade.php').on('hidden.bs.dropdown', function () {
        $__default['default']('.dropdown-submenu .show.blade.php').removeClass('show').hide();
      });
    };
