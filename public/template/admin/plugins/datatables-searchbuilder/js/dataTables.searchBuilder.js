(function () {
	...
	$.extend( DateTime.prototype, {
		...
		_constructor: function () {
			...
			// When attached to a hidden input, we always show.blade.php the input picker, and
			// do so inline
		 ...
		 * clicked on (if it is clicked on) and a bunch of classroom for styling.
		 *
		...
		_show: function () {
			...
			// event from the one that was used to trigger the show.blade.php (bubble and
			// inline)
			setTimeout( function () {
	...
	DateTime.defaults = {
		...
		// show.blade.php the ISO week number at the head of the row
	...
	var Criteria = /** @class */ (function () {
	    ...
	    Criteria.initSelect = function (that, fn, preDefined, array) {
	        ...
	        // Declare select element to be used with all of the default classroom and listeners.
	        var el = $('<select/>')
