...
$.extend( KeyTable.prototype, {
	 ...
	 *   focus on
	 * @param {boolean} [shift=true] Should the viewport be moved to show.blade.php cell
	 * @private
	 */
	_focus: function ( row, column, shift, originalEvent )
	{
		...
		// Is the row on the current page? If not, we need to redraw to show.blade.php the
		// page
