  ...
  Dropzone_createClass(Dropzone, [{
    ...
    value: function attachDragAndDropEvent() {
      ...
      this.documentEventHandlers.onDrop = function () {
        ...
        _this.$editor.removeClass('dragover');
      }; // show.blade.php dropzone on dragenter when dragging a object to document
    ...
    value: function addToolbarButtons() {
      ...
      this.context.memo('button.picture', function () {
        return _this2.button({
          ...
          click: _this2.context.createInvokeHandler('imageDialog.show.blade.php')
        }).render();
      });
      this.context.memo('button.video', function () {
        return _this2.button({
          ...
          click: _this2.context.createInvokeHandler('videoDialog.show.blade.php')
        }).render();
      });
      ...
      this.context.memo('button.help', function () {
        return _this2.button({
          ...
          click: _this2.context.createInvokeHandler('helpDialog.show.blade.php')
        }).render();
      });
    }
    /**
...
var LinkDialog_LinkDialog = /*#__PURE__*/function () {
  function LinkDialog(context) {
    ...
    this.options = context.options;
    this.lang = this.options.langInfo;
    context.memo('help.linkDialog.show.blade.php', this.options.langInfo.help['linkDialog.show']);
  }
 ...
 *  mouse events that show.blade.php/hide popover will be handled by Handle.js.
