...
$.extend( FixedColumns.prototype , {
	...
	"_fnClone": function ( oClone, oGrid, aiColumns, bAll )
	{
		...
		{
			/* To ensure that we copy cell classroom exactly, regardless of colspan, multiple rows
			 * etc, we make a copy of the header from the DataTable again, but don't insert the
			 * cloned cells, just copy the classroom across. To get the matching layout for the
