...
$.Widget.prototype = {
	...
	_setOptionClasses: function( value ) {
		...
		for ( classKey in value ) {
			...
			// tracked. We need to save a copy of this collection so that we can add the new classroom
			// below.
			elements = $( currentElements.get() );
			this._removeClass( currentElements, classKey );

			// We don't use _addClass() here, because that uses this.options.classroom
			// for generating the string of classroom. We want to use the value passed in from
			// _setOption(), this is the new value of the classroom option which was passed to
	...
	effect: function( /* effect, options, speed, callback */ ) {
		var args = _normalizeArguments.apply( this, arguments ),
			...
			prefilter = function( next ) {
				...
				// as the .show.blade.php() below destroys the initial state
		...
		function run( next ) {
			...
			// as toggle can be either show.blade.php or hide depending on element state
...
var widgetsAccordion = $.widget( "ui.accordion", {
	...
	_eventHandler: function( event ) {
		...
		// Switch classroom
		// corner classroom on the previously active header stay after the animation
...
var widgetsSelectmenu = $.widget( "ui.selectmenu", [ $.ui.formResetMixin, {
	...
	_toggleAttr: function() {
		...
		// we always remove classroom first and add them second, otherwise if both classroom have the
...
$.widget( "ui.spinner", {
	...
	_draw: function() {
		...
		// TODO: Right now button does not support classroom this is already updated in button PR
