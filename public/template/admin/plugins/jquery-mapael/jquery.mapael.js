    ...
    Mapael.prototype = {
        ...
        initZoom: function (mapWidth, mapHeight, zoomOptions) {
            ...
            $.each(zoomOptions.buttons, function(type, opt) {
                ...
                // Create div with classroom, contents and title (for tooltip)
         ...
         *  opt.ranges the range to show.blade.php:
         *  Example:
         *  opt.ranges = {
         *      'plot' : {
         *          0 : {                        // valueIndex
         ...
         *  opt.setLegendElemsState the state of legend elements to be set : show.blade.php (default) or hide
         *  opt.animDuration animation duration in ms (default = 0)
        ...
        onUpdateEvent: function (e, opt) {
            ...
            // This function show.blade.php an element using animation
            ...
            if (typeof opt.mapOptions === "object") {
                ...
                // IF we update areas, plots or legend, then reset all legend state to "show.blade.php"
            ...
            //          - slice legend is hidden AND we want to show.blade.php
            if (typeof opt.setLegendElemsState === "object") {
                // setLegendElemsState is an object listing the legend we want to hide/show.blade.php
            ...
            for (i = 0; i < sliceOptions.length; ++i) {
                ...
                if (sliceOptions[i].display === undefined || sliceOptions[i].display === true) {
                    ...
                    if (legendOptions.hideElemsOnClick.enabled) {
                        // Hide/show.blade.php elements when user clicks on a legend element
        ...
        handleClickOnLegendElem: function(elem, id, legendIndex, legendType, opts) {
            ...
            $.each(mapElems, function (y) {
                ...
                if (self.getLegendSlice(elemValue, legendOptions) === sliceOptions) {
                    ...
                    } else { // We want to show.blade.php this element
                        delete hiddenBy[legendIndex]; // Remove this legendIndex from object
                        // Check if another legendIndex is defined
                        // We will show.blade.php this element only if no legend is no longer hiding it
