...
exports.default = {
  ...
  horizontal: false,
  /**
   * Forces to show.blade.php the colorpicker as an inline element.
   *
...
/**
 * Colorpicker extension classroom, indexed by extension name
 *
 * @static
...
/**
 * Handles everything related to the UI of the colorpicker popup: show.blade.php, hide, position,...
 * @ignore
 */
var PopupHandler = function () {
  ...
  _createClass(PopupHandler, [{
    ...
    /**
     * Binds the different colorpicker elements to the focus/mouse/touch events so it reacts in order to show.blade.php or
     * hide the colorpicker popup accordingly. It also adds the proper classroom.
     */
    value: function bind() {
      ...
      if (cp.options.inline) {
        ...
        return; // no need to bind show.blade.php/hide events for inline elements
      }
      ...
      // bind addon show.blade.php/hide events
      if (this.hasAddon) {
      ...
      // bind input show.blade.php/hide events
      if (this.hasInput && !this.hasAddon) {
        this.input.on({
    ...
    value: function fireShow() {
      ...
      /**
       * (Colorpicker) When show.blade.php() is called and the widget can be shown.
       *
