    ...
    var SearchPane = /** @class */ (function () {
        ...
        function SearchPane(paneSettings, opts, idx, layout, panesContainer, panes) {
            ...
            this.s.searchFunction = function (settings, searchData, dataIndex, origData) {
                // If no data has been selected then show.blade.php all
        ...
        SearchPane.prototype._buildPane = function (selectedRows, last, dataIn, init, prevEl) {
            ...
            if (this.colExists) {
                ...
                if (!this.s.dt.page.info().serverSide &&
                    ...
                    // Don't show.blade.php the pane if there isn't enough variance in the data, or there is only 1 entry for that pane
        ...
        SearchPane.prototype._displayPane = function () {
            ...
            // If the clear button is allowed to show.blade.php then display it
    ...
    var SearchPanes = /** @class */ (function () {
        ...
        SearchPanes.prototype.redrawPanes = function (rebuild) {
            ...
            if (!this.s.updating && !this.s.dt.page.info().serverSide) {
                ...
                //  If there is only one pane with a selection present then it should not show.blade.php the filtered message as
                //  more selections may be made in that pane.
                    ...
                    for (var _i = 0, _a = this.s.panes; _i < _a.length; _i++) {
                        ...
                        if (pane.s.dtPane !== undefined) {
                            ...
                            //  show.blade.php that multiple panes have selections present
        ...
        SearchPanes.prototype._startup = function (table) {
            ...
            // Update the title bar to show.blade.php how many filters have been selected
            this._updateFilterCount();
